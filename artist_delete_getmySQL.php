<html>
<head>
    <title>Deleting for artist...</title>
...
//        ?>
        ...
        <div class="container">
            ...
            <div class="left-div">
                <div class="centerPosition">
                    put a valid word
                    <form class="divForm" name="delete" method="get" action="artist_delete_getmySQL.php">
                        <fieldset><br>
                            <legend><h2>Delete artist</h2></legend>
    ...
    $data = mysqli_query($con, "DELETE FROM artist WHERE upper($field)='$find'");
