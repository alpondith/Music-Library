...
<html>
<head>
    <title>Successful Updating of Album...</title>
        ...
        <div class="container">
            ...
            <div class="left-div">
                <div class="centerPosition">
                    put a valid word
                    <form class="divForm" name="update" method="get" action="Album_updateSucess.php">
                        <fieldset>
                            <legend><h2>Update Album</h2></legend><br>
                            <label for="insert"> Insert new value:</label>
                            <input type="text" name="insert" id="insert" /><br>
...
//Now we search for our search term, in the field the user specified
    ...
    $sql = "UPDATE album SET $field='$insert' WHERE $field='$oldValue'";
