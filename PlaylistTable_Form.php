...
<head>
    <title>Sorting by Playlist...</title>
...
<div class="middle-div">
    <div class="centerPosition">
        <form class="divForm" name="search" method="get" action="PlaylistTable_getmysql.php">
            <fieldset>
                <legend> Sorting Playlist Table</legend><br>
                Sort according to:<br>
                <label for="find"></label>
                <Select NAME="find" id="find">
                    <Option VALUE="Ptype">Playlist Type</option>
                    <Option VALUE="Pname">Playlist Name</option>
                </Select><br><br>
