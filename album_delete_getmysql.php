<html>
<head>
    <title>deleting from album...</title>
...
//If they did not enter a search term we give them an error
        ...
        <div class="container">
            ...
            <div class="left-div">
                <div class="centerPosition">
                    put a valid word
                    <form class="divForm" name="delete" method="get" action="album_delete_getmySQL.php">
                        <fieldset>
                            <legend><h2>Delete album</h2></legend><br>
    ...
    $data = mysqli_query($con, "DELETE FROM album WHERE upper($field)='$find'");
